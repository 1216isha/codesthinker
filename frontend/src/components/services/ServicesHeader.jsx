...
const ServicesHeader = () => {
    return (
        <div className='flex flex-col md:flex-row items-center pb-10 '>
            <div className='w-full md:w-[55%] h-[500px] px-6 py-20 md:pt-40 md:px-18' data-aos="fade-right">
            ...
            <div className='w-[80%] md:w-[40%] 500px  md:pt-30 md:px-10 ' data-aos="fade-left">
