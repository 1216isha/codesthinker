...
const HomeProgress = () => {
    return (
        <div className='w-full h-[500px] bg-[#F3F4F6] m-auto mt-10'>
            <div className='w-full md:w-[60%] m-auto text-center py-14'>
                <h1 className='text-5xl font-bold'  data-aos="fade-left">Our <span className='text-[#0F00AA] '>Progress</span></h1>
                <p className='text-[20px] mt-6 text-[#1B212A]'  data-aos="fade-right">TOJO GLOBAL connects your business directly to your target audience, eliminating the need to search for clients. With us, they'll find their way to you.</p>
            </div>

            <div className='flex justify-around px-40 transition-all duration-400'>
