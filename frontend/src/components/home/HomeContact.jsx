...
const HomeContact = () => {
    ...
    return (
        <div className='w-full bg-[#F9FAFB] mt-10'>

            <div className='w-full md:w-[60%] m-auto mt-3 py-10 text-center'>
                <p className='text-gray-600'>let's Talk</p>
                <h1 className='text-4xl font-bold'><span className='text-[#0F00AA] '>Let's Collaborate</span> <span className='text-[#1E2939]'>and Innovate</span></h1>
            </div>

            <div className='flex flex-col md:flex-row justify-around'>
                <div className='w-full md:w-[36%] h-[400px] flex flex-col gap-3'>
                    ...
                    <div className='w-full md:w-[100%] h-[200px] flex gap-4' data-aos="fade-right">
                        ...
                        <div className='w-full md:w-[400px]'>
                            ...
                            <p className='text-[16px] text-[#4A5565]'>Offer a no-obligation consultation to <br /> understand the client's needs and propose tailored solutions</p>
                        </div>
                ...
                <div className='w-full md:w-[45%] h-[400px] px-6 py-2 rounded-[10px] shadow-xl'  data-aos="fade-left">
                    ...
                    <form ref={form} onSubmit={sendEmail}>
                        ...
                        <button type='submit' value='send' className='btn w-full md:w-[120px] h-[50px] mt-4 ml-[395px] bg-gradient-to-r from-[#070048] to-[#0E00A6] hover:bg-gradient-to-l hover:from-[#070048] hover:to-[#0E00A6] py-3 px-6 rounded-full text-white hover:transition-all duration-300'>Send</button>
                    </form>
                </div>
            </div>
