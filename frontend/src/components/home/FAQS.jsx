...
const FAQS = () => {
    ...
    return (
        <div className='w-full md:w-[100%] bg-[#F9FAFB] py-4 px-10 pt-10'>
            <div className='w-full md:w-[500px] h-[100px] m-auto py-3 text-center'>
                <p className='text-[#4A5565] '>Have You Any Question</p>
                <h1 className='text-4xl font-bold' data-aos="zoom-in"><span className='text-[#0F00AA] '>Frequently</span> Asked Questions</h1>
            </div>


            <div className='flex flex-col md:flex-row justify-around mt-10'>
                <div className='w-full md:w-[50%] p-3 rounded-2xl'>
                    {
                        faqs.map((value, index) => (
                            <div className='' key={index}>
                                <div className='flex justify-between items-center text-[18px] font-semibold w-full md:w-[600px] bg-white py-4 px-4 rounded-[8px] mt-2 shadow-2xl' data-aos="fade-right" onClick={() => handleToggle(index)}>
                ...
                <div className='w-full md:w-[35%] h-[400px] bg-amber-200 rounded-[10px]' data-aos="flip-right">
